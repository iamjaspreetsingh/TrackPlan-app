...
/**
 * Created by JASPREET SINGH on 04-01-2018.
 */
...
public class BluetoothScan extends AppCompatActivity {
    ...
    public static final String TAG = BluetoothScan.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
        {
            ...
            window.setStatusBarColor(ContextCompat.getColor(getBaseContext(), R.color.caldroid_sky_blue));
        }
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                else if(BluetoothAdapter.ACTION_DISCOVERY_FINISHED.equals((action)))
                {
                    if(countScans == numCountScans-1)
                    {
                        ...
                        Intent in = new Intent(BluetoothScan.this, MainteachersActivity.class);
